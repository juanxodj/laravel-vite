...
import BaseHeader from "@/scripts/layouts/partials/Header.vue";
import BaseSidebar from "@/scripts/layouts/partials/Sidebar.vue";
import BaseSideOverlay from "@/scripts/layouts/partials/SideOverlay.vue";
import BaseFooter from "@/scripts/layouts/partials/Footer.vue";
