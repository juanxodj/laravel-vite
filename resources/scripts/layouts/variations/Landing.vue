...
<template>
  <BaseLayout>
    ...
    <template #header-content-left>
      <!-- Logo -->
      <RouterLink :to="{ name: 'landing' }" class="fw-bold fs-lg tracking-wider text-dual me-2">
        OneUI
    ...
    <template #header-content-right>
      <!-- Options -->
      <div class="dropdown">
        <button type="button" class="btn btn-alt-secondary me-2" id="sidebar-themes-dropdown" data-bs-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-end fs-sm smini-hide border-0"
          ...
          <button type="buttbuttonn" class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
      ...
      <!-- Purchase Link -->
      <a class="btn btn-success" href="https://1.envato.market/5Noyb" v-click-ripple>
