<template>
  <!-- Hero -->
  <BasePageHeading title="Popovers" subtitle="Similar to the ones found on iOS.">
    <template #extra>
  ...
  <div class="content">
    ...
    <BaseBlock title="Default">
      ...
      <div class="row items-push text-center">
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-primary w-100" data-bs-toggle="popover" data-bs-placement="top"
            title="Top Popover" data-bs-content="This is example content. You can put a description or more info here.">
            Top
          </button>
        </div>
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-primary w-100" data-bs-toggle="popover" data-bs-placement="right"
            title="Right Popover"
        ...
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-primary w-100" data-bs-toggle="popover" data-bs-placement="bottom"
        ...
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-primary w-100" data-bs-toggle="popover" data-bs-placement="left"
            title="Left Popover"
            data-bs-content="This is example content. You can put a description or more info here.">
            Left
          </button>
    ...
    <BaseBlock title="Click Triggered">
      ...
      <div class="row items-push text-center">
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-alt-primary w-100" data-bs-toggle="popover" data-bs-trigger="click"
    ...
    <BaseBlock title="Animation">
      ...
      <div class="row items-push text-center">
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-alt-primary w-100" data-bs-toggle="popover" data-bs-animation="true"
            data-bs-placement="top" title="Top Popover"
            data-bs-content="This is example content. You can put a description or more info here.">
            Top
          </button>
    ...
    <BaseBlock title="HTML">
      ...
      <div class="row items-push text-center">
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-alt-primary w-100" data-bs-toggle="popover" data-bs-html="true"
        ...
        <div class="col-sm-6 col-xl-3">
          <button type="button" class="btn btn-alt-primary w-100" data-bs-toggle="popover" data-bs-html="true"
            data-bs-placement="bottom" title="Popover Title"
