        ...
        <BaseBlock title="Earnings in $">
          ...
          <template #content>
            <div class="block-content p-0 text-center">
              <div class="pt-3">
                <LineChart :chart-data="earningsData" :options="earningsOptions" style="height: 350px" />
              </div>
            </div>
      ...
      <div class="col-lg-6">
        <BaseBlock title="Sales">
          ...
          <template #content>
            <div class="block-content p-0 text-center">
              <div class="pt-3">
                <LineChart :chart-data="salesData" :options="salesOptions" style="height: 350px" />
              </div>
            </div>
            <div class="block-content">
              <div class="row items-push text-center py-3">
          ...
          <table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0">
            <thead>
              <tr class="text-uppercase">
                ...
                <th class="d-none d-sm-table-cell fw-bold text-center" style="width: 100px">
                  Photo
                </th>
                <th class="fw-bold">Name</th>
                <th class="d-none d-sm-table-cell fw-bold text-center" style="width: 80px">
                  Orders
                </th>
          ...
          <table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0">
            <thead>
              <tr class="text-uppercase">
                ...
                <th class="d-none d-sm-table-cell fw-bold text-end" style="width: 120px">
                  Price
                </th>
                <th class="fw-bold text-center" style="width: 60px"></th>
              </tr>
