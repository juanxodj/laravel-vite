      ...
      <div class="content content-full">
        <div class="row g-0 justify-content-center text-center">
          <div class="col-md-10 pt-6 pb-9">
            <h1 class="fs-2 fw-bold mb-3 d-inline-flex align-items-center space-x-2">
              OneUI <span class="fw-normal ms-2">Vue Edition</span>

              <!-- Version -->
              <span class="fs-sm fw-medium py-1 px-2 rounded-pill bg-body-dark text-dark">
                v{{ store.app.version }}
              </span>
              <!-- END Version -->
            </h1>
    ...
    <div id="one-vue-hero-after" class="bg-body-light">
      <div class="content content-full">
        ...
        <div class="row py-5 text-center">
          ...
          <div class="col-6 col-md-3">
            <div class="rounded d-inline-block px-3 py-4 text-default bg-default-lighter">
    ...
    <div id="one-vue-reviews" class="bg-body-light">
      <div class="content content-full">
        <div class="py-5">
          ...
          <div class="row items-push">
            <div class="col-md-4">
              <div class="d-inline-block px-2 py-1 rounded-3 bg-warning-light text-warning mb-2">
